    ...
    <section className="py-16 bg-[#1E293B] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-[32px] p-10 lg:p-16 text-center">
          ...
          <span className="inline-flex px-4 py-2 rounded-full bg-[#C9A227]/20 text-sm  text-[#C9A227] font-medium">
            Let's Build Something Great
          </span>

          <h2 className="mt-6 text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight">
            Ready To Elevate Your
            <span className="text-[#C9A227]"> Packaging?</span>
          </h2>

          <p className="max-w-3xl mx-auto mt-6 text-md text-gray-300 leading-relaxed">
