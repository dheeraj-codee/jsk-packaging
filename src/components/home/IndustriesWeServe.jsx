    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <span className="inline-flex px-4 py-2 rounded-full bg-[#F8F7F3] text-sm text-400 text-[#C9A227] font-medium">
            Industries We Serve
          </span>
        ...
        <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4 -mx-6 px-6 md:grid md:grid-cols-2 md:gap-8 md:overflow-visible md:mx-0 md:px-0 md:pb-0 lg:grid-cols-3 mt-16">
          {industries.map((item, index) => (
            ...
            >
              ...
              <p className="mt-4 text-md text-[#64748B] leading-relaxed">
                {item.desc}
              </p>
            </div>
          ))}
