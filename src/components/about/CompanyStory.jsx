  ...
  const timeline = [
    {
      year: "2021",
      title: "Foundation",
      desc: "Founded by Amit Khandelwal and Jatin Khandelwal with a vision to deliver premium rigid and end-packaging solutions.",
    },
    {
      year: "2022",
      title: "Expansion",
      desc: "Expanded production capacity and introduced advanced printing technologies for growing client demands.",
    },
    {
      year: "2024",
      title: "Innovation",
      desc: "Added modern machinery and luxury finishing capabilities across jewellery, gift and sweet box categories.",
    },
    {
      year: "2026",
      title: "Trusted Name",
      desc: "Thousands of boxes supplied to 50+ satisfied customers across FMCG, cosmetics and gifting industries.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <span className="inline-flex items-center gap-2 rounded-full border border-[#C9A227]/20 bg-white px-5 py-2 shadow-lg">
            <span className="text-sm text-[#C9A227] font-semibold">Our Story</span>
          </span>

          <h2 className="mt-8 text-2xl md:text-3xl lg:text-4xl font-bold leading-tight text-[#1E293B]">
          ...
          <p className="mt-6 text-md leading-relaxed text-[#64748B]">
            Founded in 2021, JSK Packaging is a premier manufacturer of
            high-quality rigid and end-packaging solutions. Established by
            partners Amit Khandelwal and Jatin Khandelwal, we believe
            packaging is much more than protection — it creates first
            impressions, strengthens customer trust, and transforms
            products into memorable brand experiences.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mt-20">
            ...
            <div className="rounded-[32px] border border-[#E5E7EB] bg-white p-5 shadow-2xl">
              <div className="overflow-hidden rounded-[28px]">
                <img
                  ...
                  alt="Factory"
                  className="w-full aspect-[4/5] max-h-[560px] object-cover transition duration-700 hover:scale-105"
                />
              </div>
            </div>

            {/* Floating Card */}
            <div className="absolute bottom-6 left-6 rounded-3xl bg-white/90 backdrop-blur-xl px-7 py-5 shadow-2xl">
              <h3 className="text-5xl font-bold text-[#C9A227]">5+</h3>
              <p className="mt-2 text-[#64748B]">Years of Excellence</p>
            </div>
          ...
          >
            ...
            <p className="mt-6 text-md leading-relaxed text-[#64748B]">
              From luxury rigid boxes and jewellery boxes to sweet boxes,
              gift boxes and end packaging solutions, we create premium
              packaging experiences that elevate your products and
              strengthen your brand identity.
            </p>

            <p className="mt-5 text-md leading-relaxed text-[#64748B]">
              Every box we manufacture reflects precision, craftsmanship
              and innovation, ensuring your products leave a lasting
              impression in today's competitive marketplace.
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-20">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center rounded-3xl border border-[#E5E7EB] bg-white py-8 px-4 shadow-sm"
            >
              <h4 className="text-4xl font-bold text-[#C9A227]">{stat.value}</h4>
              <p className="mt-2 text-sm text-[#64748B] font-medium">{stat.label}</p>
            </motion.div>
          ))}
        </div>
        ...
        <div className="mt-28">
          ...
          <div className="text-center">
            <span className="text-sm text-[#C9A227] font-semibold uppercase tracking-[3px]">
              Our Journey
            </span>
            <h3 className="mt-4 text-2xl md:text-3xl lg:text-4xl font-bold text-[#1E293B]">
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="group h-full flex flex-col rounded-[28px] border border-[#E8E8E8] bg-white p-8 shadow-lg transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl">
                      ...
                      <p className="mt-4 leading-8 text-sm text-[#64748B] flex-1">
                        {item.desc}
                      </p>
                    </div>
                  </motion.div>
